...
# Crop the house region (X=70, Y=80, Width=830, Height=335)
$rect = New-Object System.Drawing.Rectangle(70, 80, 830, 335)
...
# Centered size of the house outline (Width=430, Height=174)
$destWidth = 430
$destHeight = 174
