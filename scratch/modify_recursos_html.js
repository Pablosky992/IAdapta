...
let html = fs.readFileSync('recursos.html', 'utf8');
...
if (startScript !== -1 && endScript !== -1 && startScript < endScript) {
  html = html.slice(0, startScript) + '<script type="module" src="js/recursos.js"></script>' + html.slice(endScript + 9);
...
console.log('Saved modified recursos.html');
