...
# Crop the house region (X=70, Y=80, Width=780, Height=335)
$rect = New-Object System.Drawing.Rectangle(70, 80, 780, 335)
...
# Centered size of the house outline (Width=420, Height=180)
$destWidth = 420
$destHeight = 180
