...
let html = fs.readFileSync('guias.html', 'utf8');
...
if (startScript !== -1 && endScript !== -1 && startScript < endScript) {
  html = html.slice(0, startScript) + '<script type="module" src="js/guias.js"></script>' + html.slice(endScript + 9);
...
fs.writeFileSync('guias.html', html, 'utf8');
console.log('Saved modified guias.html');
