...
const SectionContact = function SectionContact() {
  ...
  return (
    <section id="contact" className="pt-36 pb-24 px-4 bg-gradient-to-b from-brand-50 to-white relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[2.5rem] shadow-2xl border border-brand-100 w-full max-w-lg overflow-hidden transform transition-all p-8 sm:p-10 z-10">
            ...
            >
              ...
              <input type="hidden" name="subject" value="Nuevo mensaje de contacto desde IAdapta (Inicio)" />
              <input type="hidden" name="redirect" value="https://iadapta.es/" />
