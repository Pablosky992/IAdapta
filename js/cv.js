...
const SectionCV = function SectionCV() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Curriculum Vitae"), /*#__PURE__*/React.createElement("p", {
    className: "text-2xl font-bold text-brand-600 mb-2"
  }, "Pablo Narciso Mill\xE1n"), /*#__PURE__*/React.createElement("div", {
    className: "section-divider w-24 mx-auto mb-8"
  }), /*#__PURE__*/React.createElement("div", {
    className: "max-w-3xl mx-auto space-y-4 text-lg sm:text-xl text-gray-700 leading-relaxed text-left bg-white p-8 sm:p-10 rounded-3xl border border-gray-100 shadow-sm"
    ...
    className: "font-display text-2xl font-bold text-brand-900 mb-8 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center text-white text-sm font-bold"
  }, "E"), "Experiencia Profesional"), /*#__PURE__*/React.createElement("ol", {
    className: "relative space-y-8"
  }, experience.map((exp, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    className: "relative pl-12 timeline-line"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute left-0 top-1 w-10 h-10 bg-brand-600 rounded-full flex items-center justify-center shadow-md z-10"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-white text-xs font-bold"
  }, experience.length - i)), /*#__PURE__*/React.createElement("div", {
    className: "bg-white border border-brand-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow"
  }, /*#__PURE__*/React.createElement("span", {
    className: "inline-block bg-brand-100 text-brand-600 text-sm font-bold rounded-full px-3 py-1 mb-2"
  }, exp.period), /*#__PURE__*/React.createElement("h4", {
    className: "font-bold text-lg text-brand-900 leading-tight"
  }, exp.role), /*#__PURE__*/React.createElement("p", {
    className: "text-brand-500 font-medium text-base mb-2"
    ...
    className: "w-8 h-8 bg-sky-500 rounded-lg flex items-center justify-center text-white text-sm font-bold"
  }, "H"), "Competencias Destacadas"), /*#__PURE__*/React.createElement("ul", {
    className: "space-y-4"
  }, skills.map(s => /*#__PURE__*/React.createElement("li", {
    key: s.label
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between mb-1.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-brand-900 font-semibold text-base"
  }, s.label)), /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-brand-100 rounded-full h-3"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center text-white text-sm font-bold"
  }, "F"), "Formaci\xF3n Acad\xE9mica"), /*#__PURE__*/React.createElement("ul", {
    className: "space-y-4"
  }, education.map((e, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    className: "flex gap-4 bg-white rounded-2xl p-4 border border-brand-100 shadow-sm"
  }, /*#__PURE__*/React.createElement("div", {
    className: "shrink-0 w-14 h-14 bg-brand-50 rounded-xl flex items-center justify-center border border-brand-100"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-brand-600 font-bold text-sm"
  }, e.year)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    className: "font-bold text-brand-900 text-base leading-tight"
  }, e.degree), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-500 text-sm mt-0.5"
  }, e.school)))))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    className: "font-display text-2xl font-bold text-brand-900 mb-6 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "w-8 h-8 bg-teal-500 rounded-lg flex items-center justify-center text-white text-sm font-bold"
  }, "T"), "Herramientas e Idiomas"), /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-5 rounded-2xl border border-brand-100 shadow-sm"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-gray-700 mb-2"
  }, /*#__PURE__*/React.createElement("strong", null, "Idiomas:"), " Catal\xE1n (Nativo), Castellano (Nativo), Ingl\xE9s (Nivel medio)"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-700 mb-2"
  }, /*#__PURE__*/React.createElement("strong", null, "Software:"), " ResiPlus, Ortogest, Office avanzado"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-700"
  }, /*#__PURE__*/React.createElement("strong", null, "Otros:"), " Dise\xF1o y uso de Impresoras 3D, RCP.")))))));
};
function App() {
