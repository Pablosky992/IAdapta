...
const SectionGuides = function SectionGuides() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "absolute top-4 right-4 bg-white/90 backdrop-blur rounded-xl p-2 shadow-sm"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-2xl"
  }, cat.icon))), /*#__PURE__*/React.createElement("div", {
    className: "p-6 flex-1 flex flex-col"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-display text-2xl font-bold text-gray-900 mb-3 group-hover:text-brand-600 transition-colors"
  }, cat.title), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-600 flex-1"
  }, cat.description), /*#__PURE__*/React.createElement("div", {
    className: "mt-6 flex items-center text-brand-600 font-bold text-sm uppercase tracking-wide group-hover:gap-2 transition-all"
  }, "Leer Gu\xEDa Completa ", /*#__PURE__*/React.createElement("svg", {
