...
const SectionLegal = function SectionLegal() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-2xl font-bold text-brand-800 mb-4"
  }, "2. Uso de Cookies"), /*#__PURE__*/React.createElement("p", null, "Utilizamos cookies propias y de terceros para mejorar la experiencia de usuario y gestionar los enlaces de afiliaci\xF3n:"), /*#__PURE__*/React.createElement("ul", {
    className: "mt-4 space-y-2 list-disc pl-6"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Cookies de Afiliaci\xF3n:"), " Al clicar en productos recomendados, Amazon instala una cookie (24h) para identificar el origen de la compra."), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Cookies T\xE9cnicas:"), " Necesarias para recordar tus preferencias (como la aceptaci\xF3n de este aviso)."))), /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold text-brand-800 mb-4"
  }, "3. Procesamiento de datos con Inteligencia Artificial (Chatbot y Valorador Visual)"), /*#__PURE__*/React.createElement("p", null, "Nuestros servicios interactivos de Inteligencia Artificial (el Asistente Conversacional/Chatbot y la Valoraci\xF3n de la estancia) utilizan la API de Google Gemini para procesar las consultas del usuario:"), /*#__PURE__*/React.createElement("ul", {
    className: "mt-4 space-y-2 list-disc pl-6"
  }, /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Asistente Conversacional:"), " Las consultas y mensajes que env\xEDas al chat se transmiten temporalmente para generar las respuestas din\xE1micas. No guardamos, registramos ni almacenamos tus conversaciones en bases de datos de forma persistente. Se aconseja no introducir datos personales sensibles o de salud espec\xEDficos que te puedan identificar directamente."), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("strong", null, "Valorador de Estancias:"), " Las im\xE1genes enviadas se procesan de forma ef\xEDmera para generar el informe de accesibilidad. ", /*#__PURE__*/React.createElement("strong", null, "No almacenamos, compartimos ni guardamos tus im\xE1genes"), " en servidores externos, y se eliminan del sistema una vez completado el informe t\xE9cnico de adaptaciones.")))), /*#__PURE__*/React.createElement("div", {
